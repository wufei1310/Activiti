 ...
 * @create 2018-05-26
 **/
public  abstract class MyRememberMeService  implements RememberMeServices,
        InitializingBean, LogoutHandler {
    // ~ Static fields/initializers
    // =====================================================================================

    public static   String SPRING_SECURITY_REMEMBER_ME_COOKIE_KEY = "remember-me";
    public static   String DEFAULT_PARAMETER = "remember-me";
    public static   int TWO_WEEKS_S = 1209600;
    ...
    protected MyRememberMeService(String key, UserDetailsService userDetailsService) {
